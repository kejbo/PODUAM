""" Nested cross-validation of XGB standard ML models

This script allows the user to perform a repeated nested cross-validation of
XGB models with four types of molecular descriptors, which allows to optimize
different hyperparameters and assess the external prediction performance.

Computing time: 185h 12 min on central DTU HPC cluster using 8 nodes
    ...
    for seed in seed_list:
        for feat in feature_list:
            ...
            param_grid = dict(n_estimators=Integer(100, 1000),
                            ...
                            gamma=Real(1e-3, 0.1, prior='log-uniform'))
            ...
            config, out = nested_cv_sklearn(X, y, ID, model, feat, param_grid,
                                    k_outer=10, k_inner=5, nrand_cv=70, stratify=y_stratify, seed=seed)
