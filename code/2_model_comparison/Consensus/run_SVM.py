""" Nested cross-validation of SVM standard ML models

This script allows the user to perform a repeated nested cross-validation of
SVM models with four types of molecular descriptors, which allows to optimize
different hyperparameters and assess the external prediction performance.

Computing time: 7h 44 min on central DTU HPC cluster using 4 nodes
...
if __name__ == "__main__":
    ...
    for seed in seed_list:
        for feat in feature_list:
            ...
            param_grid = dict(gamma=Real(1e-3, 10, prior='log-uniform'),
