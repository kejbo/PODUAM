""" Nested cross-validation of MLR standard ML models

This script allows the user to perform a repeated nested cross-validation of
MLR models with four types of molecular descriptors, which allows to optimize
different hyperparameters and assess the external prediction performance.

Computing time: 41h 18 min on central DTU HPC cluster using 5 nodes
...
if __name__ == "__main__":
    ...
    for seed in seed_list:
        for feat in feature_list:
            ...
            param_grid = dict(alpha=Real(0.0, 1.0),
            ...
            config, out = nested_cv_sklearn(X, y, ID, model, feat, param_grid, k_outer=10, k_inner=5, nrand_cv=20, stratify=y_stratify, seed=seed)
